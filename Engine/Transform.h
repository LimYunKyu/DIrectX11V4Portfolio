...
public:
	...
	void SetCenterMatrix(Matrix mat);
	void SetCenterAccess(bool access) { CenterAccess = access; }

	void SetWorldPosition(const Vec3& position) { _worldPosition = position; }
